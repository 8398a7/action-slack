...
| if_mention | Specify success or failure or cancelled or custom.<br />Multiple statuses can be specified in csv format. e.g. success,failure | ''                    | If specified, mention only on failure.                                                                      |
